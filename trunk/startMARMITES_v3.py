    ...
    for o_ref in obs_list:
        for o in obs.keys():
            if o == o_ref:
                ...
                cMF.cPROCESS.ExportResultsMM(i, j, cMF.inputDate, SP_d, _nslmax, MM, index, MM_S, index_S, cbc_RCH[:,i,j,0], cbc_WEL, h_satflow, h_MF_m[:,i,j,l_obs], obs_h_tmp, obs_SM, index_veg, outFileExport, o)
                del cbc_WEL
                outFileExport.close()
