...
####################################
    ...
    def ppMFtime(self, MM_ws, MF_ws, inputDate_fn, inputZON_dSP_RF_veg_fn, inputZON_dSP_RFe_veg_fn, inputZON_dSP_PT_fn, input_dSP_LAI_veg_fn, inputZON_dSP_PE_fn, inputZON_dSP_E0_fn, NMETEO, NVEG, NSOIL, inputZON_dSP_RF_irr_fn = None, inputZON_dSP_RFe_irr_fn = None, inputZON_dSP_PT_irr_fn = None, input_dSP_crop_irr_fn = None, NFIELD = None):
        ...
        global inputcrop_irr, LAI_veg_stp, inputZONPT_irr, inputZONRFe_irr, inputZONRF_irr, PE_stp, RFe_veg_stp, PT_veg_stp, E0_stp, RF_veg_stp, crop_irr_stp, PT_irr_stp, RFe_irr_stp, RF_irr_stp, perlenmax, inputFilecrop_irr, inputFilePT_irr, PT_irr_d, inputFileRFe_irr, RFe_irr_d, inputFileRF_irr, RF_irr_d
...
#####################################
    ...
    def ppMF(self, MF_ws, MF_ini_fn, finf_MM = "", finf_user = None, wel_MM = "", wel_user = None, report = None, verbose = 1, chunks = 0, numDays = -1, MMsoil = 0, silent = 0):
        ...
        global finf_array, thti, thts, eps, vks, layer_row_column_head_cond, layer_row_column_elevation_cond, drn_check, layer_row_column_Q, wel_array_n, wel_array_sum, wel_input, wel_input, wel_input, finf_input, finf_input, finf_input
        if verbose == 0:
            print '--------------'
