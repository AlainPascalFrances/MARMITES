...
class binreader(object):
    ...
    def read_header(self):
        ...
        try:
            ...
            elif (isinstance(self, mfcbcread)):
                kstep = hdr[0]; kper = hdr[1]
                text = hdr[2].tostring()
            ...
            elif (isinstance(self, mtucnread)):
...
class mfcbcread(binreader):
    def __init__(self, parent, compiler='gfortran'):
        binreader.__init__(self, parent, compiler)
